...
//        node.geometry = SCNBox(width: 0.1, height: 0.1, length: 0.1, chamferRadius: 0.03)//aqui vamos colocar o tamanho do no e dizer que eh uma caixa!
        ...
        node.position = SCNVector3(0,0,-0.3)//ele 0.3 é para deixar ele distante do vetor
...
//           if data! = tru
//            UIImage(data: data!) //coloco esse UIImage na ImageView para ele aparecer!!!!!!!! //mas antes devo criar um if
//        }
//        task.resume()
//    }
//
